            ...
            <div class="row mt-4">
			 <div class="col-xl-12 col-lg-12">
                    <div class="info-content">
					  ...
					  <!-- details-->
					   <h5 class="section-title color-72 fw-700 pos-relative pb-30 mt-2"> Meso Therapy</h5>
...
<div class="product-details-wrapper">
                        <div class="product-preview-area">
                            <div class="tab-content">
                                <img src="images/hair_fall/2.jpg" alt="product-img" class="img-fluid">
                             </div>
						</div>
                        ...
                        <div class="product-details-content">
                            <h6 class="procuct-title color-d5 fw-700 text-uppercase pb-15">Meso Therapy</h6>
                            <ul class="rating">
