...
$glr_hdr_dtl="select * from job_header_image where id='1'";
...
<center>
<img src='job_header_image/<?php echo $glr_hdr_immg;?>' style="height:100px; width:100px;">
</center>
...
$folder6= "job_header_image/".$filename6;
move_uploaded_file($tempname6, $folder6);




$ad_prdt="update job_header_image set
