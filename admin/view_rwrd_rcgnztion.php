...
<h2 class="mt-30 page-title">All Reward and recognization</h2>
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active">All Reward and recognization</li>
</ol>
...
<div class='col-md-12 table table-responsive'>
    ...
    <?php 
    $usr_lst="select * from reward_recogniztion";
    ...
    ?><tr>
        <td><?php echo $sno++;?></td>
        <td><img src='reward_image/<?php echo $prd_img;?>' style="height:100px; width:100px;"></td>
     
        <td><a href='dlt_rwrd.php?id=<?php echo $prd_id?>' class='btn btn-danger'>Delete</a></td>
