...
<label class="form-label" style="font-size:16px !important;">Reward Image*</label>
...
$folder6= "reward_image/".$filename6;
move_uploaded_file($tempname6, $folder6);


$ad_prdt="insert into reward_recogniztion set
image='$filename6'";
...
if($qst_ad_prdt)
{
echo "<script>window.alert('Reward Added Successfully');window.location='';</script>";
