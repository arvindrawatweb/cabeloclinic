...
<input type='text' name="ofr_ttl"  class="form-control"  placeholder='Enter Offer Title' style="font-size: 10px !important;font-weight: 600 !important;border: 2px solid grey!important;border-radius: 15px !important;" required>
...
<input type="file" name="ofr_img" class="form-control"  style="font-size: 10px !important;font-weight: 600 !important;border: 1px solid grey!important;der-radius: 15px !important; */" required>
</div>
...
$srvc_emm=$_POST['ofr_ttl'];

$filename6 = $_FILES["ofr_img"]["name"];
$tempname6 = $_FILES["ofr_img"]["tmp_name"];    
...
$filename7 = $_FILES["srvc_brchr"]["name"];
$tempname7 = $_FILES["srvc_brchr"]["tmp_name"];    
...
$ad_prdt="insert into reward_and_recogenization set
title='$srvc_emm',
image='$filename6',
broucher='$filename7',
