...
<div class="row">
    <div class='col-md-12'>
        <br>
<center><img src="about_img/<?php echo $abt_img;?>" style="height:100px;width:100px;"></center> <br> 
    </div>
...
<label class="form-label" style="font-size:16px !important;">About Image*</label>
<input type="file" name="abtn_img" class="form-control"  style="font-size: 10px !important;font-weight: 600 !important;border: 1px solid grey!important;der-radius: 15px !important; */" >
</div>
...
$filename6 = $_FILES["abtn_img"]["name"];
$tempname6 = $_FILES["abtn_img"]["tmp_name"];    
$folder6= "about_img/".$filename6;
...
$ad_prdt="update about_content set
content='$srv_desc',
