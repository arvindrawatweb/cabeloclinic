...
<input type='text' name="srvc_tle"  class="form-control"  style="font-size: 10px !important;font-weight: 600 !important;border: 2px solid grey!important;border-radius: 15px !important;" required>
...
<label class="form-label" style="font-size:16px !important;">Video title*</label>
<input type="text" name="ttle" class="form-control"  style="font-size: 10px !important;font-weight: 600 !important;border: 1px solid grey!important;der-radius: 15px !important; */" required>
</div>
...
$folder6= "video_image/".$filename6;
move_uploaded_file($tempname6, $folder6);

$vdo_ttl=$_POST['ttle'];


$ad_prdt="insert into our_video set
video_link='$srvc_emm',
title='$vdo_ttl',
image='$filename6'";
...
if($qst_ad_prdt)
{
echo "<script>window.alert('Video Added Successfully');window.location='';</script>";
