...
$glr_hdr_dtl="select * from gallery_header_image where id='1'";
...
<center>
<img src='gallery_header_image/<?php echo $glr_hdr_immg;?>' style="height:100px; width:100px;">
</center>
...
$folder6= "gallery_header_image/".$filename6;
move_uploaded_file($tempname6, $folder6);




$ad_prdt="update gallery_header_image set
