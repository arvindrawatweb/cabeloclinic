...
<h2 class="mt-30 page-title">All Recharge Request</h2>
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active">All Recharge Request</li>
</ol>
...
<div class='col-md-12 table table-responsive'>
    ...
    <?php 
    $usr_lst="select * from recharge_request";
    $qst_usr_lst=$db->query($usr_lst);
    $sno=1;
    while($clct_usr_lst=$qst_usr_lst->fetch_assoc())
    {
    $dte=$clct_usr_lst['date'];
    $py_frm=$clct_usr_lst['pay_from'];
    $amnt=$clct_usr_lst['amount'];
    $trsctn_id=$clct_usr_lst['transaction_id'];
    $us_id=$clct_usr_lst['user_id'];
    
    
    $usr_dtl="select * from users where user_id='$us_id'";
    ...
    ?><tr>
        ...
        <td><?php echo $py_frm;?></td>
        <td><?php echo $amnt;?></td>
        <td><?php echo $trsctn_id;?></td>
