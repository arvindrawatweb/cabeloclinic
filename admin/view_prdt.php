...
<h2 class="mt-30 page-title">All Product List</h2>
...
<div class='col-md-12 table table-responsive'>
    ...
    <?php 
    $usr_lst="select * from our_products";
    ...
    while($clct_usr_lst=$qst_usr_lst->fetch_assoc())
    {
        $prd_nem=$clct_usr_lst['product_name'];
         $prd_img=$clct_usr_lst['image'];
          $prd_ctgy=$clct_usr_lst['product_price'];
    ...
    ?><tr>
        ...
        <td><img src='product_image/<?php echo $prd_img;?>' style="height:100px; width:100px;"></td>
        <td><?php echo $prd_ctgy;?></td>
        <td><?php echo $prd_desc;?></td>
        <td><a href='dlt_orprdt.php?id=<?php echo $prd_id?>' class='btn btn-danger'>Delete</a></td>
