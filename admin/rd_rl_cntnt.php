...
$prv_dtl="select * from read_rule where id='1'";
...
<label class="form-label" style="font-size:22px !important; padding-top:5px;padding-bottom:5px;">Read Rule Content</label>
...
$ad_trsnctn="update read_rule set 
content='$prc_cntnt'
where id='1'";
$qst_ad_trsnctn=$db->query($ad_trsnctn);
if($qst_ad_trsnctn)
{
 echo "<script>window.alert('Read Rule content Updated Successfully');window.location=''</script>";   
}
