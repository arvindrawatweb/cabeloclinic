...
<h2 class="mt-30 page-title">Offer of the Month</h2>
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active">Offer of the Month</li>
</ol>
...
<div class='col-md-12 table table-responsive'>
    ...
    <?php 
    $usr_lst="select * from offer_this_month";
    ...
    ?><tr>
        ...
        <td><img src='offer_image/<?php echo $prd_img;?>' style="height:100px; width:100px;"></td>
     
        <td><a href='dlt_ofr.php?id=<?php echo $prd_id?>' class='btn btn-danger'>Delete</a><a href='edt_ofr.php?id=<?php echo $prd_id?>' class='btn btn-primary'>Edit</a></td>
