...
<!-- Mirrored from beautylab.themecon.net/HTML/blog-left-sidebar-col-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Feb 2022 09:46:28 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="header-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-mail text-right"> <a href="https://beautylab.themecon.net/cdn-cgi/l/email-protection#78161e17381a1d190d0c0114191a561b1715"><i class="fa fa-envelope color-d5"></i><span class="__cf_email__" data-cfemail="89e0e7efe6c9ebece8fcfdf0e5e8eba7eae6e4">[email&#160;protected]</span></a> <span>/</span> <a href="tel:1800-111-333"><i class="fa fa-phone color-d5"></i>1800-111-333</a> </div>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <ul class="dropdown triangle">
                                    <li class="active"><a href="#">Blog pages</a>
                                        <ul class="dropdown dropdown-left">
                                            ...
                                            <li class="active"><a href="blog-left-sidebar-col-1.html">Blog left sidebar (1 Column)</a></li>
    ...
    <!-- ======================================= 
            ==Start Blog section==  
    =======================================-->
    <section class="blog-section blog-page fullwidth">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="single-blog">
                                <div class="blog-img pos-relative">
                                    <div class="img-area">
                                        <a href="blog-details.html"><img src="images/blog-1col1.jpg" alt="blog img" class="img-fluid"></a>
                                    </div>
                                    <ul class="brand">
                        ...
                        <div class="col-12">
                            <div class="single-blog">
                                <div class="blog-img pos-relative">
                                    <div class="img-area">
                                        <a href="blog-details.html"><img src="images/blog-1col2.jpg" alt="blog img" class="img-fluid"></a>
                                    </div>
                                    <ul class="brand">
                                        <li><i class="fa fa-heart"></i>18</li>
                                        <li><i class="fa fa-commenting-o"></i>10</li>
                        ...
                        <div class="col-12">
                            <div class="single-blog">
                                <div class="blog-img pos-relative">
                                    <div class="img-area">
                                        <a href="blog-details.html"><img src="images/blog-1col3.jpg" alt="blog img" class="img-fluid"></a>
                                    </div>
                                    <ul class="brand">
                                        <li><i class="fa fa-heart"></i>18</li>
                                        <li><i class="fa fa-commenting-o"></i>10</li>
                        ...
                        <div class="col-12">
                            <div class="single-blog">
                                <div class="blog-img pos-relative">
                                    <div class="img-area">
                                        <a href="blog-details.html"><img src="images/blog-1col4.jpg" alt="blog img" class="img-fluid"></a>
                                    </div>
                                    <ul class="brand">
                                        <li><i class="fa fa-heart"></i>18</li>
                                        <li><i class="fa fa-commenting-o"></i>10</li>
                        ...
                        <div class="col-12">
                            <div class="single-blog">
                                <div class="blog-img pos-relative">
                                    <div class="img-area">
                                        <a href="blog-details.html"><img src="images/blog-1col5.jpg" alt="blog img" class="img-fluid"></a>
                                    </div>
                                    <ul class="brand">
                                        <li><i class="fa fa-heart"></i>18</li>
                                        <li><i class="fa fa-commenting-o"></i>10</li>
                ...
                <div class="col-lg-4">
                    <div class="single-widget contact-widget">
                        ...
                        <address>
                            ...
                            <p class="email"><i class="fa fa-envelope"></i><span>Email:</span> <a href=":mailto:info@beautylab.com"><span class="__cf_email__" data-cfemail="c1a8afa7ae81a3a4a0b4b5b8ada0a3efa2aeac">[email&#160;protected]</span></a></p>
...
<!-- Mirrored from beautylab.themecon.net/HTML/blog-left-sidebar-col-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Feb 2022 09:46:39 GMT -->
</html>
