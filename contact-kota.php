            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="contact-number">
                        ...
                        <address>
                            <p class="address"><i class="fa fa-home "></i><span>Address:</span> Kota : 
							2nd Floor, Plot No. 2 -CH-7, Swami Dayanand Saraswati Rd, opposite Central Bank, Dadabari, Kota, Rajasthan 324009</p>
                            <p class="phone"><i class="fa fa-phone"></i><span>Phone:</span> 7300460006</p>
                            <p class="email"><i class="fa fa-envelope"></i><span>Email:</span> <a href="mailto:cabelokota@gmail.com"><span>cabelokota@gmail.com</span></a></p>
