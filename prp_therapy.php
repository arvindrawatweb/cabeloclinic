            ...
            <div class="row mt-4">
			 <div class="col-xl-12 col-lg-12">
                    <div class="info-content">
					  ...
					  <!-- details-->
					   <h5 class="section-title color-72 fw-700 pos-relative pb-30 mt-2">Platelet Rich Plasma </h5>
...
<div class="product-details-wrapper">
                        <div class="product-preview-area">
                            <div class="tab-content">
                                <img src="images/hair_fall/1.jpg" alt="product-img" class="img-fluid">
                             </div>
						</div>
                        ...
                        <div class="product-details-content">
                            <h6 class="procuct-title color-d5 fw-700 text-uppercase pb-15">Platelet Rich Plasma</h6>
                            <ul class="rating">
...
Mesotherapy (from Greek mesos, "middle", and therapy from Greek therapeia, "to treat medically") is a non-surgical cosmetic medicine treatment. Mesotherapy employs multiple injections of pharmaceutical and homeopathic medications, plant extracts, vitamins, and other ingredients into subcutaneous fat. Depending on the indications, it can be used for hair loss prevention and hair re-growth. It is highly recommended to opt for mesoscalp in combination with Derma roller or an Insulin syringe.
                            ...
                            <ul class="add-cart-area pb-35">
                                ...
                                <li>
                                    <a href="cart.php" class="addtocart color-ff text-uppercase">Add to Cart</a>
                                </li>
                                <li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-service pos-relative">
                        ...
                        <h6><a href="meso_therapy.php" class="color-d5"> Meso Therapy </a><!--<span class="float-right fw-500">$59</span>--></h6>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-service pos-relative">
                        ...
                        <div class="link-hover"><a href="#"><i class="fa fa-link color-ff"></i></a></div>
                        <h6><a href="prp_therapy.php" class="color-d5">Platelet Rich Plasma </a><!--<span class="float-right fw-500">$70</span>--></h6>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-service pos-relative">
                        ...
                        <div class="link-hover"><a href="#"><i class="fa fa-link color-ff"></i></a></div>
                        <h6><a href="#" class="color-d5">Scalp Monothreds</a><!--<span class="float-right fw-500">$40</span>--></h6>
                    </div>
                </div>
				   ...
				   <div class="col-lg-3 col-md-6">
                    <div class="single-service pos-relative">
                        ...
                        <div class="link-hover"><a href="#"><i class="fa fa-link color-ff"></i></a></div>
                        <h6><a href="#" class="color-d5"> Hair Fall Laser Therapy </a><!--<span class="float-right fw-500">$40</span>--></h6>
                    </div>
                </div>
                <!--/col-->
            </div>
